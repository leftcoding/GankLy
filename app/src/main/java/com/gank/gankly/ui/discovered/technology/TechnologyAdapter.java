 ...
 */
public class TechnologyAdapter extends RecyclerView.Adapter<TechnologyAdapter.JiandanHolder> {
    ...
    public JiandanHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.adapter_technology, parent, false);
