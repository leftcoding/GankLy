...
//        rootView.setVisibility(View.VISIBLE);
    ...
    private static void actionStarActivity(
            ...
            Bitmap colorOrImageRes, long durationMills) {
...
//        view.setScaleType(ImageView.ScaleType.CENTER_CROP);
        view.setImageBitmap(colorOrImageRes);
        final ViewGroup decorView = (ViewGroup) thisActivity.getWindow().getDecorView();
        int w = decorView.getWidth();
        int h = decorView.getHeight();
...
//                                anim.start();
    ...
    public static void startActivity(
            Activity thisActivity, Intent intent, View triggerView, Bitmap colorOrImageRes) {
        actionStarActivity(FINISH_NONE, thisActivity, intent, null, null, triggerView, colorOrImageRes, PERFECT_MILLS);
    }
