...
public class NoAlphaItemAnimator extends SimpleItemAnimator {
    ...
    private ArrayList<ArrayList<NoAlphaItemAnimator.MoveInfo>> mMovesList = new ArrayList<>();
    private ArrayList<ArrayList<NoAlphaItemAnimator.ChangeInfo>> mChangesList = new ArrayList<>();
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration())
                .alpha(0).setListener(new NoAlphaItemAnimator.VpaListenerAdapter() {
            @Override
    ...
    private void animateChangeImpl(final NoAlphaItemAnimator.ChangeInfo changeInfo) {
...
//            oldViewAnim.alpha(0).setListener(new NoAlphaItemAnimator.VpaListenerAdapter() {
...
//                    alpha(1).setListener(new NoAlphaItemAnimator.VpaListenerAdapter() {
        setListener(new NoAlphaItemAnimator.VpaListenerAdapter() {
                @Override
                public void onAnimationStart(View view) {
