...
public class WheelView extends ScrollView {
    ...
    public int offset = OFF_SET_DEFAULT; // 偏移量（需要在最前面和最后面补全）
    ...
    public void setBackground(Drawable background) {
        ...
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                int height = obtainSelectedAreaBorder()[0];
                int twoHeight = obtainSelectedAreaBorder()[1];
                canvas.drawLine(viewWidth / 6, height, viewWidth / 6 * 5, height, paint);
                canvas.drawLine(viewWidth / 6, twoHeight, viewWidth / 6 * 5, twoHeight, paint);
            }
